...
<div class="eg-each-gallery-item" data-gallery-item-key="<?php echo $gallery_item_key; ?>">
    <div class="eg-gallery-image-preview">
        ...
        <?php
        $preview_image = $gallery_item_details[ 'audio_preview_image_url' ];
        ...
        ?>
        <img src="<?php echo esc_url($preview_image); ?>" class="eg-preview-image">
    </div>
    <div class="eg-gallery-item-detail-wrap eg-backend-popup" style="display:none;">
        ...
        <div class="eg-gallery-item-detail-fields">
            ...
            <div class="eg-field-wrap">
                ...
                <div class="eg-field">
                    <select name="gallery_details[gallery_items][<?php echo $gallery_item_key; ?>][audio_type]" class="eg-audio-form-field eg-audio-type-trigger eg-gallery-form-field">
                        <option value="soundcloud" <?php selected($gallery_item_details[ 'audio_type' ], 'soundcloud'); ?>><?php _e('Soundcloud', 'everest-gallery'); ?></option>
                        <option value="self-hosted" <?php selected($gallery_item_details[ 'audio_type' ], 'self-hosted'); ?>><?php _e('Self Hosted', 'everest-gallery'); ?></option>
                    </select>
                </div>
            </div>
            <div class="eg-field-wrap eg-soundcloud-reference eg-audio-type-reference" <?php echo ($gallery_item_details[ 'audio_type' ] == 'soundcloud') ? '' : 'style="display:none"'; ?>>
                <label><?php _e('Audio URL', 'everest-gallery'); ?></label>
                <div class="eg-field">
                    <input type="text" name="gallery_details[gallery_items][<?php echo $gallery_item_key; ?>][audio_url]" placeholder="https://www.youtube.com/watch?v=qm67wbB5GmI" value="<?php echo esc_attr($gallery_item_details[ 'audio_url' ]); ?>" class="eg-gallery-form-field"/>
                </div>
            </div>
            <div class="eg-field-wrap eg-self-hosted-reference eg-audio-type-reference"  <?php echo ($gallery_item_details[ 'audio_type' ] != 'self-hosted') ? 'style="display:none"' : ''; ?>>
                ...
                <div class="eg-field">
                    ...
                    <input type="text" name="gallery_details[gallery_items][<?php echo $gallery_item_key; ?>][self_audio_url]" value="<?php echo esc_attr($gallery_item_details[ 'self_audio_url' ]); ?>" class="eg-gallery-form-field"/>
                    <input type="hidden" name="gallery_details[gallery_items][<?php echo $gallery_item_key; ?>][self_audio_id]" value="<?php echo esc_attr($gallery_item_details[ 'self_audio_id' ]); ?>" class="eg-gallery-form-field"/>
                </div>
            </div>
            <div class="eg-field-wrap">
                ...
                <div class="eg-field">
                    ...
                    <input type="text" name="gallery_details[gallery_items][<?php echo $gallery_item_key; ?>][audio_preview_image_url]" value="<?php echo esc_attr($gallery_item_details[ 'audio_preview_image_url' ]); ?>" class="eg-gallery-form-field eg-preview-image-url"/>
                    <input type="hidden" name="gallery_details[gallery_items][<?php echo $gallery_item_key; ?>][audio_preview_image_id]" value="<?php echo esc_attr($gallery_item_details[ 'audio_preview_image_id' ]); ?>" class="eg-gallery-form-field"/>
                </div>
            </div>
            <div class="eg-field-wrap">
            ...
            <input type="hidden" class="eg-gallery-form-field" name="gallery_details[gallery_items][<?php echo $gallery_item_key; ?>][gallery_item_type]" value="audio">
        </div>
    </div>
</div>