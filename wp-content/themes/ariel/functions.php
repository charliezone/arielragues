...
function ariel_styles_scripts() {
    ...
    wp_enqueue_style( 'ariel-custom-style', get_stylesheet_uri(), array('ariel-theme-style') );
    ...
    wp_enqueue_script( 'script-main', get_template_directory_uri() . '/assets/js/main.js', array('script-isotope'), '', true );
}
